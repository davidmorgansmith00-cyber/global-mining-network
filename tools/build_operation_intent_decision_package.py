...
def main() -> int:
    ...
    verification_checks = verification_payload.get("checks", evaluation.get("checks", []))
    ...
    summary["inspector_verified"] = bool(verification_payload.get("verified", False))
    summary["inspector_mismatch_count"] = int(
        verification_payload.get("inspector_summary_mismatch_count", 0)
    )
    inspector_mismatch_details = verification_payload.get("inspector_summary_mismatch_details", [])
