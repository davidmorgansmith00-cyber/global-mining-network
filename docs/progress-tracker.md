...
| Client Gameplay and UX | **In Progress - UI Phase 6** | Gameplay Lead | Phase 5 history surfaces complete; pool browse and leaderboard read-model summaries now added |
